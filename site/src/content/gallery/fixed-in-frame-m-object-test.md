...
description: "Manim Example: `FixedInFrameMObjectTest` (`#fixedinframemobjecttest`) の未移植デモ（プレースホルダー）。"
...
text title "FixedInFrameMObjectTest" at 0,-20 size=42 fill="#e2e8f0"
