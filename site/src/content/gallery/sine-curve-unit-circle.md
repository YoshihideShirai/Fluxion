...
value theta = 0
circle origin r=3 at 240,270 fill="#e2e8f0" stroke="none"
circle unit r=96 at 240,270 fill="none" stroke="#334155" strokeWidth=2
circle dot r=8 at 336,270 fill="#38bdf8" stroke="none"
line radius x1=0 y1=0 x2=96 y2=0 at 240,270 stroke="#38bdf8" strokeWidth=2
always dot.x = expr=240 + 96*cos(theta)
always dot.y = expr=270 + 96*sin(theta)
