...
description: "Manim Example: `ThreeDLightSourcePosition` (`#threedlightsourceposition`) の未移植デモ（プレースホルダー）。"
...
text title "ThreeDLightSourcePosition" at 0,-20 size=42 fill="#e2e8f0"
