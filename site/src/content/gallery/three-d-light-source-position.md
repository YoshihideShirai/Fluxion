...
threeDAxes axes at 0,28 xRange=-2.555,4,1 yRange=-3.1,4,1 zRange=-3.675,4,1 phi=75 theta=30 unitScale=67.5 stroke="#FFFFFF" strokeWidth=4 tickSize=10 tickStrokeWidth=2 includeTicks=true includeTips=true

sphereSurface sphere_mesh radius=104 worldRadius=1.5 phi=75 theta=30 unitScale=67.5 resolution=15,32 fillA="#E65A4C" fillB="#CF5044" stroke="#BBBBBB" strokeWidth=0.5 light=0,-0.35,1
