...
axes ax xRange=-5,5 yRange=-3,3 at=480,300 width=760 height=360 stroke="#94a3b8" strokeWidth=3
plot sinCurve fn="sin(t)" range=-5,5 samples=320 at=480,300 scaleX=76 scaleY=60 stroke="#38bdf8" strokeWidth=5
plot cosCurve fn="cos(t)" range=-5,5 samples=320 at=480,300 scaleX=76 scaleY=60 stroke="#f97316" strokeWidth=5
