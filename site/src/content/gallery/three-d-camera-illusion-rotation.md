...
description: "Manim Example: `ThreeDCameraIllusionRotation` (`#threedcameraillusionrotation`) の未移植デモ（プレースホルダー）。"
...
text title "ThreeDCameraIllusionRotation" at 0,-20 size=42 fill="#e2e8f0"
