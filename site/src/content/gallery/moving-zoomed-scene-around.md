...
at 3s:
  ...
  animate zoom_px_0.scale from 2 to 0.3 duration=1s easing=easeInOut
  animate zoom_px_1.scale from 2 to 0.3 duration=1s easing=easeInOut
  animate zoom_px_2.scale from 2 to 0.3 duration=1s easing=easeInOut
  animate zoom_px_3.scale from 2 to 0.3 duration=1s easing=easeInOut
