...
rect world w=700 h=360 at -70,-10 fill="none" stroke="#334155" strokeWidth=2
...
circle focus_zoom r=40 at 270,110 fill="#38bdf8" opacity=0.2 stroke="#7dd3fc" strokeWidth=3
...
at 0s:
  ...
  play FadeIn(star_a) duration=0.2s
  play FadeIn(star_b) duration=0.2s
  play FadeIn(star_c) duration=0.2s
  play FadeIn(caption) duration=0.2s
