...
4. **Design Notes**: Architecture と MVP Scope / Roadmap。
...
- [Quickstart](./guides/getting-started/) でローカル実行手順を確認する。
- [Playground tour](./guides/playground/) でブラウザ editor の操作を確認する。
- [Python DSL](./guides/python-dsl/) または [Text DSL](./reference/text-dsl/) から authoring を始める。
